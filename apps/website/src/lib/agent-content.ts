...
| Plan | Price | Custom events | AWS Accounts | History |
|------|-------|---------------|--------------|---------|
| Free | $0 | 5,000/mo | 1 | 30 days |
| Pro | $29/mo | Unlimited | 1 | 90 days |
| Business | $199/mo | Unlimited | Unlimited | 1 year |

Email sending is unmetered on every plan — you pay AWS directly and Wraps adds no per-email fee. Every plan also includes unlimited domains, contacts, templates, and team members. The only metered resource is custom events emitted via \`POST /v1/events\`, which are Wraps' own storage: 5,000/month on Free, unlimited on every paid plan. More than one AWS account requires Business.
...
- Free tier: $0/month, unmetered email sending, 5,000 custom events/month, 1 AWS account, 30-day history. Sign up at https://app.wraps.dev/sign-up.
