 ...
 */
const CLASSES = [
  "max-w-none text-base text-muted-foreground leading-relaxed",
  ...
  "[&_h3]:mt-7 [&_h3]:mb-2 [&_h3]:font-semibold [&_h3]:text-lg [&_h3]:text-foreground",
  "[&_p]:mb-4",
  ...
  "[&_.lead]:text-lg [&_.lead]:text-foreground",
  ...
  "[&_pre]:mb-5 [&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre]:border [&_pre]:border-border [&_pre]:bg-muted [&_pre]:p-4 [&_pre]:font-mono [&_pre]:text-sm [&_pre]:text-foreground",
