      ...
      <div className="container mx-auto max-w-4xl px-4 py-16">
        <article className="prose prose-gray dark:prose-invert max-w-none">
          ...
          <p>
            ...
            "we", "us", or "our"), a company registered in the State of
          ...
          <p>
            By accessing or using Wraps, you agree to be bound by these Terms.
            If you do not agree to these Terms, you may not use the Services.
          </p>

          <p>
            If you are using Wraps on behalf of an organization, you represent
          ...
          <ul>
            <li>
              Infrastructure is deployed to <strong>your AWS account</strong>,
              not ours
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <strong>Dashboard and Enterprise Features:</strong>{" "}
              Source-available with proprietary license
            </li>
          </ul>

          <p>
            The AGPLv3 license applies to the core Wraps CLI and SDK. You may
            use, modify, and distribute the software under the terms of that
            license. See our{" "}
            <a
          ...
          <p>
            <strong>You are solely responsible for all AWS charges.</strong>{" "}
            This includes:
          </p>
          ...
          <p>
            Wraps provides estimated costs during deployment, but actual costs
            may vary based on your usage. We are not responsible for AWS billing
          ...
          <ul>
            ...
            <li>
              <strong>Malware distribution:</strong> Emails containing viruses
              or malicious code
            </li>
            <li>
            ...
            <li>
              <strong>Purchased lists:</strong> Sending to email lists you
              didn't build with consent
            </li>
            <li>
          ...
          <p>
            WRAPS IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF
          ...
          <p>
            Wraps relies on AWS services (SES, DynamoDB, Lambda, etc.). We are
            not responsible for:
          </p>
          ...
          <p>
            IN NO EVENT SHALL FLATIRONKIDS LLC'S TOTAL LIABILITY EXCEED THE
            AMOUNT YOU PAID TO FLATIRONKIDS LLC IN THE TWELVE (12) MONTHS
            PRECEDING THE EVENT GIVING RISE TO LIABILITY, OR ONE HUNDRED DOLLARS
          ...
          <p>
            We may suspend or terminate your access to Wraps services
            (dashboard, support, etc.) if:
          </p>
          ...
          <p>
            Note: We cannot delete infrastructure in your AWS account. You
            remain responsible for managing your own AWS resources.
          </p>
          ...
          <p>
            Continued use of Wraps after changes constitutes acceptance of the
            new Terms.
          </p>
          ...
          <p>
            ...
            the laws of the State of Colorado, United States, without regard to
          ...
          <ol>
            ...
            <li>
              ...
              fails, disputes will be resolved through binding arbitration in
              the State of Colorado
            </li>
            <li>
              <strong>Class Action Waiver:</strong> You agree to resolve
              disputes individually and waive the right to participate in class
              actions
            </li>
          </ol>
          ...
          <p>
            ...
            to prevent actual or threatened infringement or misappropriation of
          ...
          <p>
            ...
            , constitute the entire agreement between you and Wraps regarding
            the Services.
          </p>
          ...
          <p className="text-muted-foreground text-sm">
            ...
            agree to be bound by these Terms of Service. For information about
            how we handle your data, please review our{" "}
            <Link className="text-primary hover:underline" href="/privacy">
              Privacy Policy
            </Link>
            .
