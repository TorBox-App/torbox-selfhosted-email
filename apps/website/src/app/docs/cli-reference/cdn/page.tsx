    ...
    <DocsLayout>
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="mt-2 text-muted-foreground text-sm">
                  Custom CDN domain (e.g., cdn.yourdomain.com). If you have email configured,
                  the CLI will suggest a subdomain based on your email domain.
                </p>
              </div>
              <div>
                <code className="rounded bg-muted px-2 py-1">
      ...
      <section className="mb-12">
        ...
        <p className="mb-4 text-muted-foreground">
          ...
          Use this after adding DNS records to confirm everything is working.
        </p>
      ...
      <section className="mb-12">
        ...
        <p className="mb-4 text-muted-foreground">
          ...
          Useful after CLI updates to apply fixes or when infrastructure state is out of sync.
        </p>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="mt-4 text-muted-foreground text-sm">
              <strong>Note:</strong> You'll need to manually remove DNS records (CNAME) pointing to CloudFront.
            </p>
          </CardContent>
        </Card>
      </section>
      ...
      <section className="mb-12">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Example: Upload from Node.js</CardTitle>
          </CardHeader>
          <CardContent>
            <CodeBlock
              className="h-auto"
