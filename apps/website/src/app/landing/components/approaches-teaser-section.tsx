  ...
  return (
    <section className="border-border border-b py-16 md:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="max-w-[28ch] font-heading font-semibold text-3xl text-foreground leading-none tracking-tight md:text-4xl">
        ...
        <p className="mt-9 max-w-[62ch] text-base text-muted-foreground leading-relaxed">
