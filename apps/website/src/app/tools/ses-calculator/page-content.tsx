        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-pretty text-lg text-muted-foreground">
              Calculate your true AWS SES costs — not just the $0.10/1K sending
              fee, but the full production infrastructure: EventBridge, Lambda,
              SQS, and DynamoDB. The only SES calculator that shows what
              you&apos;ll actually pay.
            </p>
          </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    AWS SES charges $0.10 per 1,000 outbound emails. This is the
                    base sending cost and what most people quote. But sending
                    emails is only part of a production setup.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    ...
                    for processing, and DynamoDB for storage. These add $1-10/mo
                    depending on volume.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Dedicated IP Costs</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    A dedicated IP costs $24.95/month. You only need one if you
                    send 100K+ emails per day consistently. Shared IPs work fine
                    for most senders with good practices.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Free Tier Benefits</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    AWS free tiers cover most low-volume infrastructure: 1M
                    Lambda requests, 1M SQS requests, and 25GB DynamoDB storage
                    per month. Small senders often pay only the SES fee.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    ...
                    at $20/mo. With SES + infrastructure, the same volume costs
                    ~$5-7/mo. The savings compound at scale.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Why Own Your Setup?</CardTitle>
                </CardHeader>
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    With SES, infrastructure runs in your AWS account. No vendor
                    lock-in, full data ownership, and transparent pay-as-you-go
                    pricing. Wraps deploys this in one command.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <section className="mt-16 space-y-8">
            ...
            <div className="mx-auto max-w-3xl space-y-4">
              <Card>
                ...
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    AWS SES costs $0.10 per 1,000 emails ($0.0001 per email) for
                    sending. However, a production email setup also requires
              ...
              <Card>
                ...
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    For a typical startup sending 50,000 emails/month with event
                    tracking and 90-day history retention, expect roughly
                    $5-10/month total including SES sending fees and supporting
                    infrastructure. Most AWS services include generous free
                    tiers that cover low-volume usage.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    SES itself charges $0.10 per 1,000 emails with no permanent
                    free sending tier. However, the supporting infrastructure
                    benefits from AWS free tiers: 1 million Lambda
                    requests/month, 1 million SQS requests/month, and 25 GB of
                    DynamoDB storage.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="text-muted-foreground text-sm">
                  <p>
                    ...
                    infrastructure setup, which tools like Wraps automate with a
                    single command.
                  </p>
                </CardContent>
              </Card>
