...
import { CLACK, seconds } from "@/lib/timing";
...
export const SuccessOutput: React.FC<SuccessOutputProps> = ({ domain }) => {
        ...
        <TerminalLine startFrame={0}>
          ...
          >
            <span style={{ color: "var(--muted-foreground)" }}>
              {/* biome-ignore lint/suspicious/noCommentText: intentional code display */}
