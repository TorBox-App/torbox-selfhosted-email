...
export const BroadcastSend: React.FC = () => {
  ...
  const dialogScale = spring({
    frame: frame - confirmAppear,
    fps,
    config: { damping: 14, stiffness: 180 },
  });
  const dialogOpacity = interpolate(
    frame,
    [confirmAppear, confirmAppear + 6],
    [0, 1],
    {
  ...
  const sankeyCol = (col: number) =>
    interpolate(
      frame,
      [sankeyStart + col * 10, sankeyStart + col * 10 + 12],
      [0, 1],
      {
        extrapolateRight: "clamp",
        extrapolateLeft: "clamp",
  ...
  const linkOpacity = (targetCol: number) =>
    interpolate(
      frame,
      [sankeyStart + targetCol * 10, sankeyStart + targetCol * 10 + 15],
      [0, 0.3],
      {
        extrapolateRight: "clamp",
        extrapolateLeft: "clamp",
  ...
  const sankeyOpacity = interpolate(
    frame,
    [sankeyStart - 2, sankeyStart + 8],
    [0, 1],
    {
      extrapolateRight: "clamp",
      extrapolateLeft: "clamp",
        ...
        >
          ...
          >
            <div>
              ...
              >
                New feature announcement · launch-announce-v2
              </div>
            </div>
            {isComplete ? (
              <div
                style={{
                  ...
                  fontSize: 10,
                  fontWeight: 500,
                  background: "oklch(0.65 0.2 145 / 12%)",
              ...
              <div
                style={{
                  ...
                  fontSize: 10,
                  fontWeight: 500,
                  background: "oklch(0.8 0.18 55 / 12%)",
            ...
            <div>
              ...
              >
                <span style={{ color: "var(--muted-foreground)" }}>
                  {processed.toLocaleString()} / 5,432
                </span>
                <span
                  style={{
                    color: "var(--foreground)",
        ...
        {showDialog && (
          ...
          >
            ...
            >
              ...
              >
                Send emails to{" "}
                <strong style={{ color: "var(--foreground)" }}>5,432</strong>{" "}
